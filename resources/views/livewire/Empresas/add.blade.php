...
@if ($id_empresa<1)
<button type="submit"  data-bs-dismiss="modal"   id="btnAdd" class="btn btn-primary close-modal">Crear Producto</button>
@else
<button type="submit"  data-bs-dismiss="modal"   id="btnAdd" class="btn btn-primary close-modal">Editar Producto</button>
@endif
                </form>
            </div>
        </div>

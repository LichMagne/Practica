           ...
           <div class="modal-body">
                <form wire:submit.prevent="storeProduct">
                    ...
                    <div class="form-group">
                        ...
                        @error('type_product') <span class="text-danger error">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="cost">Tipo de Producto</label>
...
@if ($id_producto<1)
<button type="submit"  data-bs-toggle="modal" data-bs-target="#messageModal"  id="btnAdd" class="btn btn-primary close-modal">Crear Producto</button>
@else
<button type="submit"  data-bs-toggle="modal" data-bs-target="#messageModal"  id="btnAdd" class="btn btn-primary close-modal">Editar Producto</button>
@endif
                </form>
            </div>
        </div>
